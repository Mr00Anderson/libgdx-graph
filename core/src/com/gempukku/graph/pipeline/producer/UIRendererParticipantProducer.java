...
public class UIRendererParticipantProducer implements PipelineParticipantProducer {
    @Override
    public boolean supportsType(String type) {
        return type.equals("UI");
    }
    ...
    public GraphBox createPipelineGraphBox(Skin skin, JSONObject jsonObject) {
        ...
        GraphBoxImpl start = new GraphBoxImpl(id, "UI", "UI Renderer", skin);
