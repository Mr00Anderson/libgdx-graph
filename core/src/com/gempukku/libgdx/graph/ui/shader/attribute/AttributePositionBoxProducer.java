...
public class AttributePositionBoxProducer implements GraphBoxProducer<ShaderFieldType> {
    ...
    public GraphBox<ShaderFieldType> createPipelineGraphBox(Skin skin, String id, JSONObject data) {
        ...
        AttributePositionBoxPart positionBoxPart = new AttributePositionBoxPart(skin);
        positionBoxPart.initialize(data);
        result.addGraphBoxPart(positionBoxPart);
        return result;
    }
    ...
    public GraphBox<ShaderFieldType> createDefault(Skin skin, String id) {
        GraphBoxImpl<ShaderFieldType> result = new GraphBoxImpl<ShaderFieldType>(id, configuration, skin);
        addInputsAndOutputs(result, skin);
        result.addGraphBoxPart(new AttributePositionBoxPart(skin));
        return result;
    }

    private static class AttributePositionBoxPart extends Table implements GraphBoxPart<ShaderFieldType> {
        private final SelectBox<String> selectBox;

        public AttributePositionBoxPart(Skin skin) {
