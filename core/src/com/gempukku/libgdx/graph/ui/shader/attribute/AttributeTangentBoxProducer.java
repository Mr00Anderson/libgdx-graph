...
public class AttributeTangentBoxProducer implements GraphBoxProducer<ShaderFieldType> {
    private NodeConfiguration<ShaderFieldType> configuration = new AttributeTangentShaderNodeConfiguration();
