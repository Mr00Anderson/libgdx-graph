...
public class ExponentialShaderNodeBuilder extends ConfigurationCommonShaderNodeBuilder {
    public ExponentialShaderNodeBuilder() {
        super(new ExponentialShaderNodeConfiguration());
    }
