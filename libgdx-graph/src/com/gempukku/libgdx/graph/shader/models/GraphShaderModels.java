...
public class GraphShaderModels implements Disposable {
    ...
    public void prepareForRendering(Camera camera) {
        sorter.sort(camera, models);
    }

    public Iterable<? extends GraphShaderModelInstanceImpl> getRenderablesForTransparentPass() {
        return models;
    }

    public Iterable<? extends GraphShaderModelInstanceImpl> getRenderablesForOpaquePass(final String tag) {
    ...
    private static class DistanceRenderableSorter implements Comparator<GraphShaderModelInstanceImpl> {
        ...
        public void sort(Camera camera, Array<GraphShaderModelInstanceImpl> renderables) {
            this.camera = camera;
