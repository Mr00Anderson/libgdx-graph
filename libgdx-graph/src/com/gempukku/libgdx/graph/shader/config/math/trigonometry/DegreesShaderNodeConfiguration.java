...
public class DegreesShaderNodeConfiguration extends NodeConfigurationImpl<ShaderFieldType> {
    public DegreesShaderNodeConfiguration() {
        super("Degrees", "Degrees", "Math/Trigonometry");
        addNodeInput(
