...
public class Vector3PipelinePropertyProducer implements PipelinePropertyProducer<PipelineFieldType> {
    @Override
    ...
    public WritablePipelineProperty<PipelineFieldType> createProperty(JSONObject data) {
        ...
        return new WritablePipelineProperty<PipelineFieldType>(PipelineFieldType.Vector3,
